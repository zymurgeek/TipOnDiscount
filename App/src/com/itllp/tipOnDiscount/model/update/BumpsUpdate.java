...
public class BumpsUpdate extends Update {
	private int value = 0;
	
	public BumpsUpdate(int newValue) {
		this.value = newValue;
	}
	...
	public boolean equals(Object other) {
		...
		if ( !(other instanceof BumpsUpdate) ) return false;

		// cast to native object is now safe
		BumpsUpdate otherAT = (BumpsUpdate)other;
